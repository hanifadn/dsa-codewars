...
Personal [Codewars](https://www.codewars.com/) solutions in Groovy.

- **Run locally:** [running.md#groovy](../../docs/guide/running.md#groovy)
...
| Exercise | File |
|----------|------|
| My Smallest Code Interpreter Aka Brainfk | [my-smallest-code-interpreter-aka-brainfk.groovy](5kyu/my-smallest-code-interpreter-aka-brainfk.groovy) |
