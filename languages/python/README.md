...
Personal [Codewars](https://www.codewars.com/) solutions in Python.

- **Run locally:** [docs/RUNNING.md#python](../../docs/RUNNING.md#python)
...
| Even or Odd | [even-or-odd.py](8kyu/even-or-odd.py) |
...
| Exercise | File |
|----------|------|
| Binary Addition | [binary-addition.py](7kyu/binary-addition.py) |
